...
- **`list_solana_security_rules`** - return the full standard: threat model, review checklist, and all 28 numbered rules with fixes, so the assistant can write and review Solana code safely.
