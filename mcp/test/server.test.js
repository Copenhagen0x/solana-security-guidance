...
test('list_solana_security_rules returns the full guidance (all 34 rules + threat model)', () => {
  const g = tools.listRules();
  for (let i = 1; i <= 34; i++) assert.ok(g.includes('SOL-0' + String(i).padStart(2, '0')), 'missing SOL-0' + i);
