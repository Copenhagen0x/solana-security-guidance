...
**28 of 52** rules are machine-checkable (deterministic pattern); the rest are review-only. **8** map to a catalogued real-world exploit.
...
| [SOL-038](./rules/SOL-038.md) | PDA seed collision | high | high | review | — | — |
...
| [SOL-049](./rules/SOL-049.md) | Struct-padding / non-canonical flag read | high | high | review | — | — |
