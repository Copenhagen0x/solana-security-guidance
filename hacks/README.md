...
**8 code-level exploits** — $514M lost — mapped to **8 of the 34 rules**. Plus **3 notable incidents no code rule prevents** (stolen keys, off-chain wallets), listed for honesty about scope.
